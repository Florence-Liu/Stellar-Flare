data_013 <- read.csv("~/Stellar-Flare/Input/Data/0131799991.csv")
...
write.csv(data013_flux, "./Output/Data013179991_flux_only", row.names = F)
write.csv(data129_flux, "./Output/Data129646813_flux_only", row.names = F)
write.csv(data031_flux, "./Output/Data031381302_flux_only", row.names = F)