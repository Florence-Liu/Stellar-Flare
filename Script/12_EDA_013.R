...
### ACF and PACF ###
data_013_ts <- ts(data_013$pdcsap_flux, frequency = 1000) 
data_013_ts_drop_missing <- ts(data_013_drop_missing$pdcsap_flux, frequency = 1000) 
...
data_013_sim_ts <- ts(data_013_sim$pdcsap_flux, frequency = 1000)
